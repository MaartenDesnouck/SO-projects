 ...
 */
final public class ChatController extends eventbroker.EventPublisher{
    ...
    private void initialize(){
        ...
        eventbroker.EventBroker.getEventBroker().addEventListener(handler);
    ...
    private class ChatEventHandler implements eventbroker.EventListener{
        
        @Override
        public void handleEvent(eventbroker.Event e){
